...
const AnniversaryPage = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex h-[100vh] w-[100%] flex-col justify-center items-center">
        <div className="w-full h-full rounded-lg postcard scale-up flex flex-col justify-center items-center">
          <ReactTypingEffect
            text="วันครบรอบเดือนที่ 2 ของเราแล้วนะคะ ไอ้หมาน้อย ขอบคุญที่อยู่ข้างโอมตลอดนะ ถึงแม้จะมีทะเลาะกันบ้าง ขอโทษบ่อยเลยแหละ แห่ะๆ โอมอยากไปเที่ยวกับขวัญทุกที่ ๆ เลย เราไปเที่ยวด้วยกันสนุกมากเลยนะ ขอบคุณที่เป็นห่วงตลอดนะคะ ขอบคุณที่รักกันมากขนาดนี้ โอมก็รักขวัญที่สุดเลยน้าา มุมุ 💕 ปล.เก็บตังไปเที่ยวกันเถอะ 🤗"
            speed={50}
            eraseSpeed={20}
            className="text-xl w-[400px] max-[840px]:text-lg max-[480px]:text-lg text-wrap max-[800px]:w-[175px] max-[800px]:h-[90px] text-center"
          />
        </div>
      </div>
