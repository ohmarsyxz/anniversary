...
const CardSlider = () => {
  const cards = [
    { id: 1, video: "src/assets/dreamworld.mp4", title: "Dreamworld" },
    { id: 2, video: "src/assets/dreamworld.mp4", title: "Adventure" },
    { id: 3, video: "src/assets/dreamworld.mp4", title: "Nature" },
  ];
