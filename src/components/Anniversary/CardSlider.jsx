...
const CardSlider = () => {
  const cards = [
    { id: 1, video: "public/images/dreamworld.mp4", title: "Dreamworld" },
    { id: 2, video: "public/images/dreamworld.mp4", title: "Adventure" },
    { id: 3, video: "public/images/dreamworld.mp4", title: "Nature" },
  ];
